...
const TransactionDeletionsPage = lazy(() => import('../features/admin/trash/TransactionDeletionsPage').then((m) => ({ default: m.TransactionDeletionsPage })));
  ...
  return (
    ...
    <Routes>
      ...
      >
        ...
        <Route path="admin/transaction-deletions" element={<Gate anyOf={['admin.delete.transaction', 'admin.delete.approve']}><TransactionDeletionsPage /></Gate>} />
