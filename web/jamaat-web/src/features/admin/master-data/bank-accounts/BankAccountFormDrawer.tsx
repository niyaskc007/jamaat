  ...
  return (
    ...
    >
      <Form layout="vertical" requiredMark={false}>
        <Form.Item label="Display name" required validateStatus={errors.name ? 'error' : ''} help={errors.name?.message}>
          <Controller name="name" control={control} render={({ field }) => <Input {...field} autoFocus placeholder="Jamaat Main Account" />} />
        </Form.Item>
        <Form.Item label="Bank name" required validateStatus={errors.bankName ? 'error' : ''} help={errors.bankName?.message}>
          <Controller name="bankName" control={control} render={({ field }) => <Input {...field} />} />
        </Form.Item>
        <Form.Item label="Account number" required validateStatus={errors.accountNumber ? 'error' : ''} help={errors.accountNumber?.message}>
          <Controller name="accountNumber" control={control} render={({ field }) => <Input {...field} className="jm-tnum" />} />
        </Form.Item>
        <Form.Item label="Branch"><Controller name="branch" control={control} render={({ field }) => <Input {...field} />} /></Form.Item>
        <Form.Item label="IFSC"><Controller name="ifsc" control={control} render={({ field }) => <Input {...field} />} /></Form.Item>
        <Form.Item label="SWIFT"><Controller name="swiftCode" control={control} render={({ field }) => <Input {...field} />} /></Form.Item>
        <Form.Item label="Currency" required validateStatus={errors.currency ? 'error' : ''} help={errors.currency?.message}>
