  ...
  return (
    ...
    >
      <Form layout="vertical" requiredMark={false}>
        ...
        <Form.Item label="Prefix" required validateStatus={errors.prefix ? 'error' : ''} help={errors.prefix?.message}>
          <Controller name="prefix" control={control} render={({ field }) => <Input {...field} />} />
        </Form.Item>
        <Form.Item label="Pad length" required>
          <Controller name="padLength" control={control} render={({ field }) => <InputNumber min={1} max={12} {...field} style={{ inlineSize: 120 }} />} />
        </Form.Item>
        <Form.Item label="Year reset (resets counter on Jan 1, includes YY in number)">
