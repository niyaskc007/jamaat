...
export function MemberPortalLayout() {
  ...
  const items = [
    { key: '/portal/me', icon: <HomeOutlined />, label: 'Home' },
    { key: '/portal/me/profile', icon: <UserOutlined />, label: 'My profile' },
    { key: '/portal/me/contributions', icon: <GiftOutlined />, label: 'My contributions' },
    { key: '/portal/me/commitments', icon: <HeartOutlined />, label: 'My commitments' },
    { key: '/portal/me/qarzan-hasana', icon: <BankOutlined />, label: 'Qarzan Hasana' },
    { key: '/portal/me/guarantor-inbox', icon: <TeamOutlined />, label: 'Guarantor inbox' },
    { key: '/portal/me/events', icon: <CalendarOutlined />, label: 'Events' },
    { key: '/portal/me/login-history', icon: <HistoryOutlined />, label: 'Login history' },
  ];
      ...
      <Layout>
        <Layout.Header className="jm-portal-header">
          ...
          <Dropdown
            ...
            menu={{
              items: [
                { key: 'profile', icon: <UserOutlined />, label: 'My profile', onClick: () => navigate('/portal/me/profile') },
                { key: 'change-pw', icon: <LockOutlined />, label: 'Change password', onClick: () => navigate('/change-password?returnTo=/portal/me') },
            ...
            <Button type="text" className="jm-portal-header-trigger">
              <Space>
                ...
                <div className="jm-portal-user-block">
                  ...
                  <div className="jm-portal-user-role">Member</div>
                </div>
              </Space>
            </Button>
          </Dropdown>
