...
// CommitmentProgressCard moved to shared/ui/CommitmentProgressCard.tsx so the operator and
// member-portal commitment-detail pages render identical visualisation. RULES.md §15.
